...
typedef struct
{
	...
	lv_obj_t *screen_OTA_btn_OTA_download;
	lv_obj_t *screen_OTA_btn_OTA_download_label;
	lv_obj_t *screen_OTA_cont_OTA_top;
...
LV_IMAGE_DECLARE(_partlycloudy_RGB565A8_100x100);
LV_IMAGE_DECLARE(_rainy_RGB565A8_100x100);
LV_IMAGE_DECLARE(_sunny_RGB565A8_100x100);
