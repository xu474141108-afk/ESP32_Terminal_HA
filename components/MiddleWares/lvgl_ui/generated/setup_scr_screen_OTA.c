...
void setup_scr_screen_OTA(lv_ui *ui)
{
    ...
    //Write codes screen_OTA_img_OTA
    ui->screen_OTA_img_OTA = lv_animimg_create(ui->screen_OTA_cont_OTA_main);
    lv_obj_set_pos(ui->screen_OTA_img_OTA, 13, 27);
    lv_obj_set_size(ui->screen_OTA_img_OTA, 100, 100);
    lv_animimg_set_src(ui->screen_OTA_img_OTA, (const void **) screen_OTA_img_OTA_imgs, 1);
    lv_animimg_set_duration(ui->screen_OTA_img_OTA, 30*1);
    lv_animimg_set_repeat_count(ui->screen_OTA_img_OTA, LV_ANIM_REPEAT_INFINITE);
    lv_image_set_src(ui->screen_OTA_img_OTA, screen_OTA_img_OTA_imgs[0]);
