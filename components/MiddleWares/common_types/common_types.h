...
#define OTA_VERSION_AVAILABLE_FLAG         BIT0 // 标志位：新版本可用
#define OTA_UPDATE_STARTED_FLAG            BIT1 // 标志位：OTA 更新开始
#define OTA_UPDATE_CANCELLED_FLAG          BIT2 // 标志位：OTA 更新取消         
#define OTA_EVENT_SUCCESS                  BIT3 // 更新成功
#define OTA_EVENT_FAILED                   BIT4 // 更新失败
#define OTA_EVENT_REBOOT                   BIT5 // 请求重启
